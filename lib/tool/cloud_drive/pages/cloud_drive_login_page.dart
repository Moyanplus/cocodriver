...
//   void initState() {
//     super.initState();
//     LogManager().cloudDrive('🌐 云盘登录 WebView 初始化: ${widget.url}');
//     _initializeWebView();
//   }
...
//                 LogManager().cloudDrive('🚀 开始加载页面: $url');
//                 setState(() {
//                   _isLoading = true;
//                   _error = null;
//                 });
...
//                 LogManager().error(
//                   '❌ WebView 资源加载错误: ${error.description}',
//                   null,
//                 );
//                 setState(() {
//                   _isLoading = false;
...
//                 LogManager().cloudDrive('🔗 导航请求: ${request.url}');
...
//     try {
//       LogManager().cloudDrive('🍪 开始获取 Cookie...');
...
//         LogManager().cloudDrive('✅ 成功获取真实 Cookie');
//         LogManager().cloudDrive('🍪 原始 Cookie: $cookieString');
//         LogManager().cloudDrive('🍪 Cookie 长度: ${cookieString.length}');
...
//           LogManager().cloudDrive('⚠️ Cookie 中缺少 ylogin，可能未完成登录');
//           if (mounted) {
...
//         }
//       } else {
//         LogManager().cloudDrive('⚠️ 未获取到任何 Cookie');
//         if (mounted) {
//           ScaffoldMessenger.of(context).showSnackBar(
//             const SnackBar(
...
//       }
//     } catch (e) {
//       LogManager().error('❌ 获取 Cookie 失败: $e');
//       if (mounted) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
...
//     try {
//       LogManager().cloudDrive('🔍 开始分析 Cookie 内容...');

//       final cookieMap = <String, String>{};
//       final cookieList = cookies.split(';');

//       LogManager().cloudDrive('🍪 Cookie 总数: ${cookieList.length}');
...
//           LogManager().cloudDrive('✅ 找到关键 Cookie: $cookieName');
//         } else {
//           LogManager().cloudDrive('❌ 缺少关键 Cookie: $cookieName');
//         }
//       }

//       LogManager().cloudDrive('🍪 所有 Cookie 键: ${cookieMap.keys.toList()}');
//     } catch (e) {
//       LogManager().error('❌ 分析 Cookie 失败: $e');
//     }
//   }
