...
/// 账号状态管理器
class AccountNotifier extends StateNotifier<CloudDriveState> {
  AccountNotifier() : super(const CloudDriveState());
  ...
  Future<void> loadAccounts() async {
    try {
      ...
      state = state.copyWith(
        accounts: accounts,
        isLoading: false,
        currentAccount: accounts.isNotEmpty ? accounts[0] : null,
      );
    } catch (e) {
...
/// 账号Provider
final accountProvider = StateNotifierProvider<AccountNotifier, CloudDriveState>(
  (ref) => AccountNotifier(),
);
