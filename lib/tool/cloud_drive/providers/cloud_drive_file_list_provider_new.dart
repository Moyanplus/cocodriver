...
/// 文件列表状态管理器
class FileListNotifier extends StateNotifier<CloudDriveState> {
  FileListNotifier() : super(const CloudDriveState());
...
final fileListProvider =
    StateNotifierProvider<FileListNotifier, CloudDriveState>(
